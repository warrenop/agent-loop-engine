...
5. **进入 IMPLEMENT 后**:若 plan 改动清单为空/极小(无实质改动,如功能已存在),**本会话直接做完** IMPLEMENT→VERIFY 即可;**有实质多步改动**才**派 subagent 自动接管**(无需 /clear)——用 Task 工具派一个 general-purpose subagent,prompt 为——
